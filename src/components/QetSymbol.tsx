...
export function QetSymbol({ className = "h-full w-full" }: { className?: string }) {
  return (
    <svg viewBox="0 0 56 56" className={className} aria-hidden>
      <path d="M 28.00 3.00 A 25 25 0 0 1 50.66 38.57 L 41.59 34.34 A 15 15 0 0 0 28.00 13.00 Z" fill="#3d54b0" />
      <path d="M 49.65 40.50 A 25 25 0 0 1 7.52 42.34 L 15.71 36.60 A 15 15 0 0 0 40.99 35.50 Z" fill="#2d7a56" />
      <path d="M 6.35 40.50 A 25 25 0 0 1 25.82 3.10 L 26.69 13.06 A 15 15 0 0 0 15.01 35.50 Z" fill="#c9862a" />
    </svg>
  );
}
