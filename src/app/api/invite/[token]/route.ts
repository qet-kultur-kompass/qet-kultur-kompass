...
// einreichende Person ihre eigenen Ergebnisse später im persönlichen
// Dashboard (/mein-dashboard) wiederfindet. Diese Verknüpfung wird
...
//
// Seit V2.0 (Mehrfach-Tests/Re-Audit, siehe Roadmap): ein Invitee darf
// denselben oder einen anderen Scope beliebig oft einreichen – jede
// Einreichung wird als eigener, datierter Submission-Datensatz gespeichert.
// "completed"/"completedAt" markiert nur noch die letzte Einreichung, ist
// kein Sperre mehr.
